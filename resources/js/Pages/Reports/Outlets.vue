        ...
        <template #header>
            ...
            >
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <span
                        class="rounded-full border border-orange-400/20 bg-orange-500/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-orange-300"
                    >
                        Owner Only
                    </span>
                    <span
                ...
                <div v-else class="divide-y divide-white/10">
                    ...
                    >
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                Delta order
                                {{ outlet.growth.order_amount > 0 ? '+' : ''
                                }}{{ outlet.growth.order_amount }}
                            </p>
                        </div>
                    </article>
                </div>
