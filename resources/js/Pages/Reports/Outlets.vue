        ...
        <div class="space-y-6">
            ...
            <section class="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
                <article class="rounded-3xl border border-white/10 bg-slate-950/70 p-5 shadow-[0_30px_80px_rgba(15,23,42,0.35)]">
                    ...
                    <div v-if="!outlets.length" class="mt-5 rounded-2xl border border-dashed border-white/10 px-4 py-10 text-center text-sm text-slate-400">
                            ...
                            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center gap-2">
                                        <p class="truncate text-sm font-black text-white">{{ outlet.name }}</p>
                                        <component
                    ...
                    <div class="mt-5 space-y-3">
                        ...
                        >
                            <div class="flex items-center justify-between gap-3">
                                <div>
                                    <p class="text-sm font-black text-white">{{ outlet.name }}</p>
                                    <p class="mt-1 text-xs text-slate-400">
            ...
            <section class="rounded-3xl border border-white/10 bg-slate-950/70 shadow-[0_30px_80px_rgba(15,23,42,0.35)]">
                ...
                <div v-if="!outlets.length" class="px-5 py-10 text-center text-sm text-slate-400">
                ...
                <div v-else class="divide-y divide-white/10">
                    ...
                    >
                        <div class="space-y-2">
                            <div class="flex items-center gap-2">
                                <h3 class="text-base font-black text-white">{{ outlet.name }}</h3>
                                <span
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm font-semibold text-white">{{ outlet.current.orders }}</p>
                            <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-500">Average ticket</p>
                            <p class="text-sm text-slate-300">{{ formatPrice(outlet.current.average_ticket) }}</p>
                        </div>
