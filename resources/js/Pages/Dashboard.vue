            ...
            >
                <div>
                    ...
                    >
                        {{ user?.name }}
                        <span
                            class="ml-2 text-sm font-normal text-stone-500 dark:text-slate-400"
                ...
                <div class="flex items-center gap-3">
                    ...
                    >
                        <select
                            ...
                            class="rounded-2xl border border-stone-200 bg-white/[0.04] px-3 py-2 text-sm text-stone-900 outline-none transition focus:border-orange-400/40 dark:border-white/10 dark:text-white"
                            @change="applyFilter"
                        >
                    ...
                    <span
                        class="flex items-center gap-1.5 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1.5 text-xs font-semibold text-emerald-400"
                    >
                        <span
        ...
        <div class="space-y-5">
            ...
            <section v-if="canViewFinance">
                ...
                >
                    ...
                    <article
                        class="relative col-span-2 overflow-hidden rounded-[24px] border border-emerald-400/20 bg-gradient-to-br from-emerald-500/20 via-emerald-500/8 to-slate-950 p-5 xl:col-span-2"
                    >
                        <div
                            class="pointer-events-none absolute -right-6 -top-6 h-28 w-28 rounded-full bg-emerald-500/15 blur-2xl"
                        />
                        <p
                            class="text-[10px] font-bold uppercase tracking-[0.22em] text-emerald-300"
                        >
                            Revenue Hari Ini
                        </p>
                        <p
                            class="mt-2 text-3xl font-black text-stone-900 dark:text-white"
                        >
                            {{ fmt(fs.revenue) }}
                        </p>
                        <div class="mt-2 flex items-center gap-2">
                            <span
                                class="inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[11px] font-bold"
                                :class="growthClass"
                            >
                        ...
                        >
                            Kemarin {{ fmt(fs.yesterday_revenue) }}
                        </p>
                    </article>

                    <!-- Total Order -->
                    <article
                        class="rounded-[24px] border border-stone-200 bg-white/[0.03] p-5 dark:border-white/10"
                    >
                        <p
                            class="text-[10px] font-bold uppercase tracking-[0.22em] text-stone-500 dark:text-slate-400"
                        >
                            Total Order
                        </p>
                        <p
                        ...
                        <div class="mt-2 flex flex-wrap gap-1.5">
                            <span
                                class="rounded-full border border-emerald-400/20 bg-emerald-500/10 px-2 py-0.5 text-[10px] font-semibold text-emerald-300"
                            >
                                {{ fs.settled_orders ?? 0 }} selesai
                            </span>
                            <span
                                v-if="(fs.pending_orders ?? 0) > 0"
                                class="rounded-full border border-amber-400/20 bg-amber-500/10 px-2 py-0.5 text-[10px] font-semibold text-amber-300"
                            >
                    ...
                    <!-- Produk terlaris -->
                    <article
                        class="rounded-[24px] border border-sky-400/15 bg-sky-500/8 p-5"
                    >
                        <div class="flex items-start justify-between gap-2">
                            <p
                                class="text-[10px] font-bold uppercase tracking-[0.22em] text-sky-300"
                            >
                                Top Produk
                            </p>
                        ...
                        <p
                            class="mt-2 text-base font-black leading-tight text-stone-900 dark:text-white"
                        >
                            {{ fs.top_product?.name || '–' }}
                        </p>
                    ...
                    <article
                        ...
                        :class="
                            fs.active_shift
                                ...
                                : 'border-stone-200 bg-white/[0.03] dark:border-white/10'
                        "
                    >
                        <p
                ...
                <div class="mt-4 grid gap-4 lg:grid-cols-[1.6fr_1fr_1fr]">
                    ...
                    <div
                        class="rounded-[24px] border border-stone-200 bg-white p-5 dark:border-white/10 dark:bg-slate-950/50"
                    >
                        ...
                        <div
                            v-else
                            class="mt-6 text-center text-xs text-stone-400 dark:text-slate-500"
                        >
                    ...
                    >
                                ...
                                >
                                    <div class="flex items-center gap-1.5">
                                        <component
                                            ...
                                            class="h-3 w-3 text-stone-500 dark:text-slate-400"
                                        />
                                        <span
                                            class="text-xs font-semibold text-stone-800 dark:text-slate-200"
                                            >{{
                                    ...
                                    <span
                                        class="text-[11px] font-black text-emerald-300"
                                        >{{ fmtShort(item.amount) }}</span
                                    >
                                </div>
                                <div
                                    class="h-1.5 overflow-hidden rounded-full bg-stone-100 dark:bg-white/5"
                                >
                                    <div
                        ...
                        <p
                            v-else
                            class="mt-4 text-xs text-stone-400 dark:text-slate-500"
                        >
                    ...
                    >
                        ...
                        <div v-if="topProducts.length" class="mt-4 space-y-2.5">
                            ...
                            >
                                <span
                                    ...
                                    :class="
                                        i === 0
                                            ...
                                            : 'bg-stone-100 text-stone-400 dark:bg-white/5 dark:text-slate-500'
                                    "
                                    >{{ i + 1 }}</span
                                >
                                <div class="min-w-0 flex-1">
                                    <p
                                        class="truncate text-xs font-semibold text-stone-800 dark:text-slate-200"
                                    >
                                        {{ p.name }}
                                    </p>
                                    <p
                                ...
                                <span
                                    class="flex-shrink-0 text-[11px] font-black text-sky-300"
                    ...
                    >
                        ...
                        >
                            <div
                                ...
                                :key="item.source"
                                class="flex items-center justify-between rounded-2xl border border-stone-200 bg-white/[0.03] px-3.5 py-2.5 dark:border-white/10"
                            >
                                <div>
                                    <p
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    class="text-[11px] font-bold text-orange-200"
                                    >Buat Order</span
                                >
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                <span class="text-[11px] font-bold text-sky-200"
                                    >Kitchen</span
                                >
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                <span
                                    class="text-[11px] font-bold text-amber-200"
                                    >Alert Stok</span
                                >
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                <span
                                    class="text-[11px] font-bold text-rose-200"
                                    >Expired</span
                                >
                            </Link>
                        </div>
            ...
            <section v-else class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                <Link
                    :href="route('kasir.order')"
                    class="flex flex-col items-center gap-3 rounded-[24px] border border-orange-400/20 bg-orange-500/10 py-6 text-center transition hover:bg-orange-500/15"
                >
                    <ShoppingCart class="h-7 w-7 text-orange-300" />
                    <span class="text-sm font-bold text-orange-200"
                        >Buat Order</span
                    >
                </Link>
                <Link
                    :href="route('kitchen.display')"
                    class="flex flex-col items-center gap-3 rounded-[24px] border border-sky-400/20 bg-sky-500/10 py-6 text-center transition hover:bg-sky-500/15"
                >
                ...
                <Link
                    :href="route('stock-alerts.index')"
                    class="flex flex-col items-center gap-3 rounded-[24px] border border-amber-400/20 bg-amber-500/10 py-6 text-center transition hover:bg-amber-500/15"
                >
                ...
                <Link
                    :href="route('expired-tracking.index')"
                    class="flex flex-col items-center gap-3 rounded-[24px] border border-rose-400/20 bg-rose-500/10 py-6 text-center transition hover:bg-rose-500/15"
                >
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                ...
                >
                    <div class="flex items-center justify-between gap-3">
                        <div class="flex items-center gap-2.5">
                            <div
                                class="flex h-8 w-8 items-center justify-center rounded-xl bg-amber-500/15"
                            >
                        ...
                        <Link
                            :href="route('stock-alerts.index')"
                            class="flex items-center gap-1 text-[11px] font-semibold text-orange-300 hover:text-orange-200"
                        >
                    ...
                    <div class="mt-3 flex flex-wrap gap-2">
                        <span
                            class="rounded-full border border-amber-400/20 bg-amber-500/10 px-2.5 py-1 text-[11px] font-semibold text-amber-200"
                        >
                            {{ lowStockSummary.products }} produk jadi
                        </span>
                        <span
                            class="rounded-full border border-sky-400/20 bg-sky-500/10 px-2.5 py-1 text-[11px] font-semibold text-sky-200"
                        >
                            {{ lowStockSummary.raw_materials }} bahan baku
                        </span>
                        <span
                            class="rounded-full border border-rose-400/20 bg-rose-500/10 px-2.5 py-1 text-[11px] font-semibold text-rose-200"
                        >
                    ...
                    <div
                        ...
                        class="mt-4 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 text-xs text-emerald-300"
                    >
                    ...
                    <div v-else class="mt-3 space-y-2">
                        <article
                            ...
                            class="flex items-center justify-between gap-3 rounded-2xl border border-stone-200 bg-white/[0.02] px-3.5 py-2.5 transition hover:bg-white/[0.04] dark:border-white/5"
                        >
                            <div class="min-w-0 flex-1">
                                <div class="flex items-center gap-1.5">
                                    <p
                                        class="truncate text-xs font-bold text-stone-900 dark:text-white"
                                    >
                                        {{ item.name }}
                                    </p>
                                    <span
                                        class="flex-shrink-0 rounded-full border px-1.5 py-0.5 text-[9px] font-bold"
                                        :class="
                                            item.severity >= 2
                            ...
                            <Link
                                ...
                                class="flex-shrink-0 rounded-xl border border-orange-400/20 bg-orange-500/10 px-2.5 py-1.5 text-[10px] font-bold text-orange-300 hover:bg-orange-500/15"
                            >
                                Tindak
                            </Link>
                        </article>
                        <p
                            ...
                            class="mt-1 text-center text-[11px] text-stone-400 dark:text-slate-500"
                        >
                ...
                >
                    <div class="flex items-center justify-between gap-3">
                        <div class="flex items-center gap-2.5">
                            <div
                                class="flex h-8 w-8 items-center justify-center rounded-xl bg-rose-500/15"
                            >
                    ...
                    <div class="mt-3 flex flex-wrap gap-2">
                        ...
                        <span
                            class="rounded-full border border-orange-400/20 bg-orange-500/10 px-2.5 py-1 text-[11px] font-semibold text-orange-200"
                        >
