...
<template>
    ...
    <AuthenticatedLayout>
            ...
            >
                <div class="flex flex-col gap-2 border-b border-slate-800/80 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                        ...
                        class="rounded-full border border-slate-800 bg-slate-950/70 px-3 py-1 text-[11px] font-semibold text-slate-400 transition hover:border-slate-700 hover:text-white"
                    >
                        Buka Katalog Produk
                    </Link>
                </div>
                ...
                <div v-else class="grid gap-4 p-5 lg:grid-cols-2">
                    ...
                    >
                        ...
                        <button
                            ...
                            class="mt-4 inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 px-4 py-3 text-sm font-bold text-white"
                        >
                            Update Stok
                        </button>
                    </article>
        ...
        >
            <div
                class="w-full max-w-xl rounded-[28px] border border-slate-800/80 bg-slate-950 p-5 shadow-[0_30px_120px_rgba(2,6,23,0.7)]"
            >
                ...
                <form class="mt-5 space-y-4" @submit.prevent="submitStockUpdate">
                    <div class="grid gap-4 md:grid-cols-3">
                        <label class="block">
                            ...
                            <input
                                ...
                                type="number"
                                min="0"
                                class="mt-2 w-full rounded-2xl border border-slate-800 bg-slate-900 px-4 py-3 text-sm text-white focus:border-orange-500 focus:outline-none"
                            />
                            <p
                    ...
                    <div
                        ...
                        class="grid gap-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-4 md:grid-cols-2"
                    >
                        <label class="block">
                            <span class="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-500">
                                Batch Code
                            ...
                            <input
                                ...
                                type="text"
                                class="mt-2 w-full rounded-2xl border border-slate-800 bg-slate-950 px-4 py-3 text-sm text-white focus:border-orange-500 focus:outline-none"
                            />
                            <p
                    ...
                    <div class="flex flex-col gap-2 pt-2 sm:flex-row sm:justify-end">
                        ...
                        <button
                            ...
                            class="inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 px-4 py-3 text-sm font-bold text-white disabled:cursor-not-allowed disabled:opacity-60"
                        >
                            Simpan Perubahan
                        </button>
                    </div>
