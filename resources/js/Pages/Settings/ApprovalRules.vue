                        ...
                        <div class="rounded-3xl border border-slate-800 bg-slate-950/50 p-5">
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <button
                                    ...
                                    :class="form.manual_discount_enabled ? 'border-emerald-500/20 bg-emerald-500/10 text-emerald-300' : 'border-slate-700 bg-slate-900 text-slate-400'"
                                >
                        ...
                        <div class="rounded-3xl border border-slate-800 bg-slate-950/50 p-5">
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <button
                                    ...
                                    class="rounded-full border px-3 py-1 text-[11px] font-bold uppercase tracking-wider"
                                    :class="form.order_edit_enabled ? 'border-emerald-500/20 bg-emerald-500/10 text-emerald-300' : 'border-slate-700 bg-slate-900 text-slate-400'"
                                >
                    ...
                    <div class="rounded-3xl border border-slate-800/80 bg-slate-900/80 p-6">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="rounded-2xl border border-slate-800 bg-slate-950/50 p-4">
                                <p class="text-sm font-bold text-white">Diskon Manual</p>
                            ...
                            <div class="rounded-2xl border border-slate-800 bg-slate-950/50 p-4">
                                <p class="text-sm font-bold text-white">Edit Order</p>
                                <p class="mt-2 text-xs leading-6 text-slate-400">
                                    Diterapkan saat total order hasil edit mencapai atau melewati nominal threshold outlet.
                                </p>
                            </div>
                            <div class="rounded-2xl border border-slate-800 bg-slate-950/50 p-4">
                                <p class="text-sm font-bold text-white">PIN Supervisor Lama</p>
                                <p class="mt-2 text-xs leading-6 text-slate-400">
                                    Untuk order status <code class="rounded bg-slate-950 px-1.5 py-0.5 text-[11px] text-orange-300">in_progress</code>, rule supervisor tetap berlaku bila threshold owner tidak terpenuhi.
                                </p>
                            </div>
                        </div>
                    </div>
