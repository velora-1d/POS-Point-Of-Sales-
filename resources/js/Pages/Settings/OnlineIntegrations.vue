        ...
        <div class="space-y-6">
            ...
            <div class="grid gap-6">
                <section
                    ...
                    :key="entry.key"
                    class="rounded-3xl border border-stone-200 dark:border-slate-800/80 bg-stone-50 dark:bg-slate-900/80 p-6"
                >
                    <div class="flex flex-col gap-4 border-b border-stone-200 dark:border-slate-800/80 pb-5 xl:flex-row xl:items-start xl:justify-between">
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <span
                                    ...
                                    :class="entry.form.is_active ? 'border-emerald-500/20 bg-emerald-500/10 text-emerald-300' : 'border-stone-200 dark:border-slate-700 bg-stone-100 dark:bg-slate-950 text-stone-500 dark:text-slate-400'"
                                >
                            ...
                            <p class="mt-3 text-xs text-stone-400 dark:text-slate-500">
                                Webhook terakhir: {{ formatDateTime(entry.config.summary.last_synced_at) }}
                            </p>
                        </div>

                        <div class="grid gap-3 text-sm text-stone-600 dark:text-slate-300 sm:grid-cols-3">
                            <div class="rounded-2xl border border-stone-200 dark:border-slate-800 bg-white dark:bg-slate-950/50 px-4 py-3">
                                <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-stone-400 dark:text-slate-500">
                                    Outlet Aktif
                                </p>
                                <p class="mt-2 text-lg font-black text-stone-900 dark:text-white">
                            ...
                            <button
                                ...
                                class="rounded-2xl border border-stone-200 dark:border-slate-800 bg-white dark:bg-slate-950/50 px-4 py-3 text-left transition hover:border-stone-200 dark:border-slate-700"
                            >
                                <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-stone-400 dark:text-slate-500">
                                    Webhook URL
                                </p>
                    ...
                    <div class="mt-6 grid gap-6 xl:grid-cols-[0.85fr_1.15fr]">
                        <div class="space-y-5 rounded-3xl border border-stone-200 dark:border-slate-800 bg-white dark:bg-slate-950/50 p-5">
                            <div class="flex items-center justify-between gap-4">
                                <div>
                                    <p class="text-sm font-bold text-stone-900 dark:text-white">Status Integrasi</p>
                                ...
                                <button
                                    ...
                                    :class="entry.form.is_active ? 'border-emerald-500/20 bg-emerald-500/10 text-emerald-300' : 'border-stone-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-stone-500 dark:text-slate-400'"
                                >
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        class="w-full rounded-2xl border border-stone-200 dark:border-slate-800 bg-stone-100 dark:bg-slate-950 pl-4 pr-12 py-3 text-sm text-stone-900 dark:text-slate-100 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
                                    />
                                    <button
                                        type="button"
                                ...
                                <p class="mt-2 text-[11px] text-stone-400 dark:text-slate-500">
...
Outlet Mapping</p>
                            ...
                            <div class="mt-5 space-y-3">
                                <div
                                    ...
                                    class="grid gap-3 rounded-2xl border border-stone-200 dark:border-slate-800 bg-stone-50 dark:bg-slate-900/40 p-4 lg:grid-cols-[0.9fr_1.1fr_auto]"
                                >
                                    <div>
                                        <p class="text-sm font-bold text-stone-900 dark:text-white">
                                    ...
                                    <div class="flex items-end">
                                        <span
                                            class="rounded-full border px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider"
                                            :class="mapping.external_outlet_id ? 'border-emerald-500/20 bg-emerald-500/10 text-emerald-300' : 'border-stone-200 dark:border-slate-700 bg-stone-100 dark:bg-slate-950 text-stone-400 dark:text-slate-500'"
                                        >
