...
<template>
    ...
    >
        <div
            ...
            class="fixed inset-0 z-40 flex items-center justify-center overflow-y-auto bg-stone-900/40 dark:bg-slate-950/85 p-4 backdrop-blur-sm"
        >
                ...
                <div class="flex items-start justify-between gap-4 border-b border-stone-200 dark:border-slate-800/80 px-6 py-5">
                    <div>
                        <div class="flex flex-wrap items-center gap-2">
                            <span class="rounded-full border border-sky-500/20 bg-sky-500/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.22em] text-sky-600 dark:text-sky-300">
                                Edit Order
                            </span>
                    ...
                    <div class="flex min-h-0 flex-col border-r border-stone-200 dark:border-slate-800/70">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <div class="relative w-full max-w-xs">
                                    ...
                                    <input
                                        ...
                                        class="border-stone-200 dark:border-slate-800 w-full rounded-xl border bg-stone-50 dark:bg-slate-950 py-2 pl-9 pr-4 text-xs text-stone-800 dark:text-slate-200 placeholder-stone-400 dark:placeholder-slate-500 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
                                    />
                                </div>
                            </div>
                                ...
                                <button
                                    ...
                                    :class="[
                                        ...
                                        editCategory === 'all'
                                            ...
                                            : 'border-stone-200 dark:border-slate-800 bg-stone-50 dark:bg-slate-950/60 text-stone-600 dark:text-slate-400 hover:text-stone-900 dark:hover:text-slate-200',
                                    ]"
                                >
                                    Semua
                                </button>
                            ...
                            <div class="custom-scrollbar mt-4 max-h-56 overflow-y-auto pr-1">
                                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                                    <button
                                        ...
                                        class="rounded-2xl border border-stone-200 dark:border-slate-800 bg-stone-50 dark:bg-slate-950/60 p-3 text-left transition hover:border-orange-500/30 hover:bg-white dark:hover:bg-slate-950"
                                    >
                                        <p class="text-xs font-bold text-stone-900 dark:text-white">{{ product.name }}</p>
                                        <p class="mt-1 line-clamp-2 text-[10px] text-stone-500">{{ product.description || 'Tidak ada deskripsi.' }}</p>
                        ...
                        <div class="custom-scrollbar min-h-0 flex-1 space-y-3 overflow-y-auto px-6 py-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="rounded-full border border-stone-200 dark:border-slate-700 bg-stone-100 dark:bg-slate-950 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-stone-600 dark:text-slate-300">
                                    {{ editItemCount }} item
                                </span>
                            </div>
                            ...
                            <div
                                ...
                                class="space-y-3 rounded-2xl border border-stone-200 dark:border-slate-800 bg-stone-50 dark:bg-slate-950/60 p-4"
                            >
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <button
                                        ...
                                        class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-red-200 dark:border-red-900/30 bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 transition hover:text-red-700 dark:hover:text-red-300"
                                    >
                                ...
                                <div class="flex items-center gap-2">
                                    <button
                                        ...
                                        class="flex h-7 w-7 items-center justify-center rounded-lg border border-stone-200 dark:border-slate-800 bg-stone-100 dark:bg-slate-900 text-stone-600 dark:text-slate-300"
                                    >
                                        <Minus class="h-3 w-3" />
                                    </button>
                                ...
                                <input
                                    ...
                                    class="border-stone-200 dark:border-slate-800 w-full rounded-xl border bg-stone-50 dark:bg-slate-900 px-4 py-2.5 text-xs text-stone-800 dark:text-slate-200 placeholder-stone-400 dark:placeholder-slate-500 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
                                />
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="5"
                                    class="border-stone-200 dark:border-slate-800 w-full resize-none rounded-2xl border bg-stone-50 dark:bg-slate-950 px-4 py-3 text-xs text-stone-800 dark:text-slate-200 placeholder-stone-400 dark:placeholder-slate-500 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
                                    placeholder="Update catatan utama order untuk dapur..."
                                ></textarea>
                            </div>

                            <div v-if="editOrderNeedsApproval" class="rounded-2xl border border-amber-200 dark:border-amber-500/20 bg-amber-50 dark:bg-amber-500/5 p-4">
                                <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-orange-500">Persetujuan Supervisor</p>
