...
class PromoService
{
    ...
    ): array
    {
        ...
        $promoPayload = [
                ...
                'discount_percent' => $type === 'percent' ? $payload['discount_percent'] : null,
                'discount_amount' => $type === 'nominal' ? $payload['discount_amount'] : null,
                'max_discount_amount' => $type === 'percent' ? ($payload['max_discount_amount'] ?: null) : null,
                'min_transaction_amount' => $payload['min_transaction_amount'] ?: null,
                'buy_quantity' => $type === 'buy_x_get_y' ? $payload['buy_quantity'] : null,
                'get_quantity' => $type === 'buy_x_get_y' ? $payload['get_quantity'] : null,
                'can_stack' => (bool) ($payload['can_stack'] ?? false),
                'usage_limit' => $payload['usage_limit'] ?: null,
                'start_date' => $payload['start_date'],
                'end_date' => $payload['end_date'] ?: null,
                'happy_hour_start' => $payload['happy_hour_start'] ?: null,
                'happy_hour_end' => $payload['happy_hour_end'] ?: null,
